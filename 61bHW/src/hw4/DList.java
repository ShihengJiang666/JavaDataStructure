...
public class DList {
  ...
  public static void main(String[] args){
	  ...
	  int [] addArray ={1,2,3};
	  System.out.println(list1.toString());
	  list1.insertAfter(1, list1.head.next);
	  System.out.println(list1.toString());
	  list1.insertBefore(5, list1.head.prev);
	  System.out.println(list1.toString());
	  list1.remove(list1.head.next.next);
	  System.out.println(list1.toString());
	  LockDList list2 = new LockDList();
	  for (int i = 1; i < 10; i++){
		  list2.insertFront((int)(100*Math.random()));
	  }
	  System.out.println(list2.toString());
	  list2.remove(list2.head.next);
	  System.out.println(list2.toString());
	  list2.lockNode(list2.head.next);
	  list2.remove(list2.head.next);
	  System.out.println(list2.toString());
	  list2.remove(list2.head.next.next);
	  System.out.println(list2.toString());
