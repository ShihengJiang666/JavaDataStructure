		  ...
		  if (children() > 0){
			  if (children()>= c){
				  if (children() == 1){
					  ...
					  firstChild = newNode;
					  newNode.parent = this;
					  newNode.nextSibling = temp;
					  myTree.size ++;
				  }else{
					  SibTreeNode cur = (SibTreeNode)(child(c-1));
				  ...
				  SibTreeNode cur = (SibTreeNode)(child(children()));
				  SibTreeNode newNode = new SibTreeNode(myTree, item);
				  cur.nextSibling = newNode;
				  newNode.parent = this;
				  myTree.size ++;
		  ...
		  if (children() == 0){
			  if (this != this.parent.firstChild){
				  if (this.nextSibling!=null){
					  ...
					  SibTreeNode prev = (SibTreeNode)(child(count - 1));
					  SibTreeNode next = (SibTreeNode)(child(count + 1));
