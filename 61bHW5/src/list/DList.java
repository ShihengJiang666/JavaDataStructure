...
public class DList extends List {
   ...
   **/
  public DList() {
	  DListNode head = newNode(null, null, null, null);
	  this.head = head;
	  head.prev = head;
	  head.next = head;
	  size = 0;
  ...
  public static void main(String[] argv) {
    ...
    //my test for insertAfter and insertBefore:
    DList a = new DList();
    a.insertFront(new Integer(3));
    a.insertFront(new Integer(2));
    a.insertFront(new Integer(1));
    System.out.println(a.toString());
    try {
		a.head.next.insertAfter(5);
